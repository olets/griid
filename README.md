...
Or it from the rawgit CDN (remember to update the URL to the latest version)
	...
	https://cdn.rawgit.com/olets/griid/v2.1.6/griid.less
	https://cdn.rawgit.com/olets/griid/v2.1.6/griid-functions.less
...
Explanations of all the adjustments are here. You might also **[check out the test suite](https://cdn.rawgit.com/olets/griid/v2.1.6/tests/griid-tests.html) for an example of each available adjustment**.
